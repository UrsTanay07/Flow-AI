...
const defaultItems: SocialItem[] = [
  { letter: "C", icon: <FaGithub />, label: "Github", href: "https://github.com" },
  { letter: "O", icon: <FaTwitter />, label: "Twitter", href: "https://x.com" },
  { letter: "N", icon: <FaLinkedin />, label: "LinkedIn", href: "https://www.linkedin.com" },
  { letter: "T", icon: <FaInstagram />, label: "Instagram", href: "https://www.instagram.com" },
  { letter: "A", icon: <FaFacebook />, label: "Facebook", href: "https://www.facebook.com" },
  { letter: "C", icon: <FaEnvelope />, label: "Email", href: "mailto:contact@flowai.in" },
  { letter: "T", icon: <FaDiscord />, label: "Discord", href: "https://discord.com" },
];

const SocialFlipNode: React.FC<{
  item: SocialItem;
  index: number;
  isHovered: boolean;
  ...
  return (
    <Wrapper
      {...wrapperProps}
      className={cn("relative h-8 w-8 cursor-pointer block", itemClassName)}
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-0 flex items-center justify-center rounded-lg bg-neutral-100 text-sm font-bold text-neutral-800 shadow-sm dark:bg-neutral-900 dark:text-neutral-200",
            frontClassName
          )}
        ...
        <div
          className={cn(
            "absolute inset-0 flex items-center justify-center rounded-lg bg-black text-sm text-white dark:bg-white dark:text-black",
            backClassName
          )}
          style={{
...
export default function SocialFlipButton({
  ...
  // Note: we can remove the isDark check since we only use CSS dark mode
  return (
    <div className={cn("flex items-center justify-center gap-4 p-4", className)}>
      <div
        className="group relative flex items-center justify-center gap-1.5 rounded-2xl glass-border bg-white p-2 shadow-sm dark:bg-black"
